...
$(function () {
    ...
    function navigation_menu() {
        ...
        $('.menu-dropdown-icon, .sub-dropdown').on('click', function () {
            if ($(window).width() <= winWidthSm) {
    ...
    function leftbarMenu() {
        ...
        var leftbarMenuBtn = $('.leftbar-menu_btn'),
            leftbarMenu = $('.leftbar-menu'),
            leftbarNotification = $('.unreadTop'),
            leftbarMenuClose = $('.leftbar-close-icon'),
            leftbarBtnActive = 'active',
            leftbarMenuActive = 'leftbar-menu-open',
            leftbarBtnParentActive = 'cart-active';

        var openLeftbar = function () {
            leftbarMenuBtn.toggleClass(leftbarBtnActive);
            leftbarMenu.toggleClass(leftbarMenuActive);
            leftbarMenuBtn.parent().toggleClass(leftbarBtnParentActive);
        }
        var closeLeftbar = function () {
            leftbarMenuBtn.removeClass(leftbarBtnActive);
            leftbarMenu.removeClass(leftbarMenuActive);
            leftbarMenuBtn.parent().removeClass(leftbarBtnParentActive);
        }

        leftbarMenuClose.on('click', function (event) {
            closeLeftbar();
        });
        ...
        leftbarNotification.on('click', function (event) {
            event.stopPropagation();
            openLeftbar();
        });

        leftbarMenuBtn.on('click', function (event) {
            event.stopPropagation();
            openLeftbar();
        });

        $document.on('click touchstart', function (event) {
            if (!$(event.target).closest('.leftbar-menu, .leftbar-menu_btn').length) {
                closeLeftbar();
            }
        });
